    ...
    public partial class AddTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Desls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Desls_CustomerUsers_CustomerUserId",
                        column: x => x.CustomerUserId,
                        principalTable: "CustomerUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Desls_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Desls_SellerUsers_SellerUserId",
                        column: x => x.SellerUserId,
                        principalTable: "SellerUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Desls_CustomerUserId",
                table: "Desls",
                column: "CustomerUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Desls_ProductId",
                table: "Desls",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Desls_SellerUserId",
                table: "Desls",
                column: "SellerUserId");
